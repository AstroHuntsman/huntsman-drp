...
wget -r -l1 -c -N --no-parent --no-host-directories --cut-dirs=2 -A "index-420[3-9]*.fits" -P ./data/ http://broiler.astrometry.net/~dstn/4200/
# because I don't know how to regex...
wget -r -l1 -c -N --no-parent --no-host-directories --cut-dirs=2 -A "index-4211*.fits" -P ./data/ http://broiler.astrometry.net/~dstn/4200/